...
//                builder.setTitle("选择模式:");
    ...
    private void shareQuestion() {
        ...
        Bitmap bp=captureScreen(NewExamActivity.this);
        ivTime.setImageBitmap(bp);
        if( !CompressImage.compressFromBpToFile(NewExamActivity.this, bp)){Tools.ToastShort("压缩图片失败");return;}
        Intent  intent=new Intent(NewExamActivity.this, MakeTopicActivity.class);
