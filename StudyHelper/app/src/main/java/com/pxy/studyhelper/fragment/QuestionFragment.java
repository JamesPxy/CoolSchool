...
//            getActivity().finish();
    ...
    public void showAnswer() {
        ...
        if (CheckAnswer()) {
            tvExplaination.setBackgroundResource(R.color.answer_right);
            tvExplaination.setText("恭喜您，答对啦！" + "\n" + "正确答案: " + str + "\n" + "解析: " + mQuestion.getExplaination());
        } else {
            tvExplaination.setBackgroundResource(R.color.red);
            tvExplaination.setText("您答错了！" + "\n" + "正确答案: " + str + "\n" + "解析: " + mQuestion.getExplaination());
        }
